...
- Claude親はCodex委任にcodex execを使う。Claude向けwrapperは\`/Users/sawairikeisuke/.agents/bin/codex-delegate.mjs\`を使う。Codex親はnative subagentを使う。標準モデルはgpt-5.6-luna / max。
